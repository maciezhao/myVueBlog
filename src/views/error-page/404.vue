<template>
  <div style="min-height: 500px">
    <div class="svg-class">
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 800 600" style="visibility: visible">
        <g>
          ...
          <g id="planet" transform="matrix(0.9994,-0.0349,0.0349,0.9994,-3.8056,34.2406)" style="transform-origin: 0px 0px">
            ...
            <circle
              ...
              cy="62.319"
              r="13.074"
              transform="matrix(1,0,0,1,2.999,0)"
          ...
          <g id="stars">
            <g id="starsBig">
              <g transform="matrix(0.9978,-0.0664,0.0664,0.9978,-31.3004,69.9277)" style="transform-origin: 0px 0px">
                <line
                  fill="none"
                  stroke="#0E0620"
                  stroke-width="3"
              ...
              <g transform="matrix(0.999,0.0427,-0.0427,0.999,20.1512,-12.1069)" style="transform-origin: 0px 0px">
                <line
                  fill="none"
                  stroke="#0E0620"
                  stroke-width="3"
              ...
              <g transform="matrix(0.9989,-0.0465,0.0465,0.9989,-12.2247,29.8001)" style="transform-origin: 0px 0px">
                <line
                  fill="none"
                  stroke="#0E0620"
                  stroke-width="3"
              ...
              <g transform="matrix(0.9978,-0.0668,0.0668,0.9978,-64.439,28.3136)" style="transform-origin: 0px 0px">
                <line
                  fill="none"
                  stroke="#0E0620"
                  stroke-width="3"
            ...
            <g id="starsSmall">
              ...
              <g transform="matrix(1,0,0,1,0.3649,0.7326)" style="transform-origin: 0px 0px">
                <line
                  fill="none"
                  stroke="#0E0620"
                  stroke-width="3"
              ...
              <g transform="matrix(0.998,0,0,0.9987,29.0669,24.3828)" style="transform-origin: 0px 0px">
                <line
                  fill="none"
                  stroke="#0E0620"
                  stroke-width="3"
            ...
            <g id="circlesBig">
              <circle
                ...
                cy="255.978"
                r="7.952"
                transform="matrix(1,0,0,1,0,-1.999)"
                style="transform-origin: 0px 0px"
              ></circle>
          ...
          <g id="spaceman" clip-path="url(cordClip)" transform="matrix(0.9998,0.0174,-0.0174,0.9998,7.5421,1.4542)" style="transform-origin: 0px 0px">
            <path
              id="cord"
              fill="none"
              stroke="#0E0620"
            ...
            <g id="head">
              ...
              <path
                ...
                transform="matrix(0.9998,0.0174,-0.0174,0.9998,9.0305,-4.8305)"
                style="transform-origin: 0px 0px"
              ></path>
    ...
    <div class="page-info">
      <h1 style="font-size: 6rem; margin: 1.5rem 0">404</h1>
      <h2 style="font-size: 2rem; margin: 1rem 0">OH! 页面丢失</h2>
      <p style="margin: 1rem">您所寻找的页面不存在。你可以点击下面的按钮，返回主页。</p>
      <router-link to="/"><el-button type="primary" style="margin: 1rem">返回主页</el-button></router-link>
    </div>
  </div>
</template>
